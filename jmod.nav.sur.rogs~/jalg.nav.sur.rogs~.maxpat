...
,
		"rect" : [ 372.0, 144.0, 1045.0, 613.0 ],
		"bglocked" : 0,
		"defrect" : [ 372.0, 144.0, 1045.0, 613.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 825.0, 510.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 530.0, 71.0, 17.0 ],
					"text" : "midiGain $1"
				}
...
,
					"patching_rect" : [ 825.0, 490.0, 66.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 825.0, 465.0, 200.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 485.0, 53.0, 17.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 405.0, 545.0, 152.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 670.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 646.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 622.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 598.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 574.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 550.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 526.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 502.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 478.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 454.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 430.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 406.0, 433.0, 18.0, 75.0 ],
					"text" : "pass~"
				}
...
,
						"rect" : [ 25.0, 69.0, 335.0, 80.0 ],
						"bglocked" : 0,
						"defrect" : [ 25.0, 69.0, 335.0, 80.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 13.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 405.0, 405.0, 284.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"fontname" : "Arial",
...
,
						...
						"bglocked" : 0,
						"defrect" : [ 93.0, 563.0, 614.0, 410.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 115.0, 335.0, 52.0, 20.0 ],
									"text" : "s #0.init"
								}
...
,
										...
										"bglocked" : 0,
										"defrect" : [ 1414.0, 44.0, 261.0, 159.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 405.0, 515.0, 282.5, 20.0 ],
					"text" : "jcom.pack≈ 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 475.0, 280.0, 445.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 420.0, 310.0, 490.0, 20.0 ],
					"text" : "jcom.oscroute /trigger /turn /position /onsetVar /pitch /pitchVar /size /speed /gain"
				}
...
,
						"rect" : [ 208.0, 544.0, 673.0, 195.0 ],
						"bglocked" : 0,
						"defrect" : [ 208.0, 544.0, 673.0, 195.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
...
,
									"patching_rect" : [ 99.0, 135.0, 37.0, 17.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"fontname" : "Arial",
...
,
									"patching_rect" : [ 12.0, 132.0, 50.0, 17.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"fontname" : "Arial",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.0, 124.0, 39.0, 17.0 ],
									"text" : "$1 20"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 195.0, 144.0, 36.0, 19.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 195.0, 168.0, 18.0, 18.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 102.0, 171.0, 18.0, 18.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.0, 168.0, 18.0, 18.0 ]
								}
...
,
					"patching_rect" : [ 405.0, 340.0, 365.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 794.0, 197.0, 153.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 817.0, 176.0, 68.0, 19.0 ],
					"text" : "s #0.return"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.0, 149.0, 104.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 835.0, 75.0, 106.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 828.0, 126.0, 100.0, 17.0 ],
					"text" : "s #0_sampLength"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 835.0, 102.0, 113.5, 17.0 ],
					"text" : "info~ #0_buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 270.0, 260.0, 83.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.oscroute /numChannels /position /pitch /grain /buffer /turn /mod /modAmt /audio"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "rogs~ 2 50 #0_buffer 10. 0. 0. 320.",
					"varname" : "rogs"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 197.611115, 148.0, 279.5, 148.0 ],
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 79.5, 334.0, 570.200012, 334.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 311.5, 334.5, 674.0, 334.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 279.5, 334.5, 622.099976, 334.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 357.166656, 334.5, 414.5, 334.5 ],
					"source" : [ "obj-18", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 320.833344, 243.0, 320.0, 243.0, 320.0, 334.0, 725.900024, 334.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 2 ],
					"hidden" : 0,
					"midpoints" : [ 795.833313, 334.0, 414.0, 334.0, 414.0, 177.0, 218.0, 177.0, 218.0, 180.0, 216.5, 180.0 ],
					"source" : [ "obj-63", 7 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 1 ],
					"hidden" : 0,
					"midpoints" : [ 815.833313, 305.0, 414.0, 305.0, 414.0, 177.0, 191.0, 177.0, 191.0, 181.0, 193.0, 181.0 ],
					"source" : [ "obj-64", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 169.5, 334.850098, 518.299988, 334.850098 ],
					"source" : [ "obj-99", 0 ]
				}
