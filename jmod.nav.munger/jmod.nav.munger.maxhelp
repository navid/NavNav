{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 137.0, 83.0, 689.0, 664.0 ],
		"bglocked" : 0,
		"defrect" : [ 137.0, 83.0, 689.0, 664.0 ],
...
,
					"patching_rect" : [ 53.0, 384.0, 51.0, 20.0 ],
					"presentation_rect" : [ 81.0, 485.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 54.0, 410.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 373.0, 267.0, 18.0 ],
					"text" : "/numChannels 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 565.0, 150.0, 20.0 ],
					"text" : "dry out"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 527.0, 538.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 195.0, 178.0, 34.0 ],
					"text" : "2nd Argument: maximum delay size in ms. (bufferSize)"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.nav.munger", "@description", "multichannel granulator with 1-32 channels of output" ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
,
					"patching_rect" : [ 31.0, 487.0, 51.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 163.0, 449.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 144.0, 338.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 208.0, 83.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 54.0, 231.0, 450.0, 140.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 1 ],
					"hidden" : 1,
					"midpoints" : [ 358.0, 228.0, 494.5, 228.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 494.5, 395.5, 63.5, 395.5 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 63.5, 396.0, 40.5, 396.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 63.5, 397.0, 27.5, 397.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 2 ],
					"hidden" : 0,
					"midpoints" : [ 250.833328, 484.5, 611.5, 484.5 ],
					"source" : [ "obj-24", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 157.166672, 531.5, 308.5, 531.5 ],
					"source" : [ "obj-24", 1 ]
				}
