...
,
		"rect" : [ 409.0, 286.0, 1223.0, 762.0 ],
		"bglocked" : 0,
		"defrect" : [ 409.0, 286.0, 1223.0, 762.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 33.0, 196.0, 87.0, 31.0 ],
...
,
						"rect" : [ 32.0, 275.0, 152.0, 69.0 ],
						"bglocked" : 0,
						"defrect" : [ 32.0, 275.0, 152.0, 69.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 13.0,
						"default_fontface" : 0,
...
,
										...
										"bglocked" : 0,
										"defrect" : [ 113.0, 530.0, 226.0, 394.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 593.0, 711.0, 595.0, 32.0 ],
					"text" : "jcom.parameter ramp @type integer @range/bounds 0. 20000. @range/clipmode low @description \"interpolation: ramp time in ms\"",
					"varname" : "slide/up[5]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 170.0, 33.0, 18.0 ],
					"text" : "ramp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 536.0, 725.0, 44.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 170.0, 36.0, 18.0 ],
					"triangle" : 0
				}
...
,
						...
						"bglocked" : 0,
						"defrect" : [ 596.0, 235.0, 930.0, 595.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 13.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 124.0, 195.0, 102.0, 21.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 189.0, 32.0, 17.0 ],
					"rounded" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 329.0, 57.0, 21.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 155.0, 14.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 22.0, 47.0, 18.0 ],
					"text" : "pre-slide"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 87.0, 21.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 21.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 512.0, 404.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 133.0, 141.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 41.0, 141.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 154.0, 33.0, 18.0 ],
					"text" : "offset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 152.0, 42.0, 18.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 66.0, 64.0, 18.0 ],
					"text" : "window size"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 65.0, 48.0, 18.0 ],
					"triangle" : 0,
					"varname" : "window"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 57.0, 29.0, 17.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 128.0, 47.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 288.0, 376.0, 161.0, 90.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 155.0, 77.0, 50.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 3
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 80.0, 29.0, 18.0 ],
					"text" : "max"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 80.0, 26.0, 18.0 ],
					"text" : "min"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 111.0, 24.0, 18.0 ],
					"text" : "out"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 90.0, 18.0, 18.0 ],
					"text" : "in"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 135.0, 30.0, 18.0 ],
					"text" : "slide"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 61.0, 135.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 135.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 471.0, 397.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 45.0, 113.0, 19.0 ],
					"types" : [  ],
					"varname" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 46.0, 566.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 91.0, 56.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 387.0, 333.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 324.0, 322.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 262.0, 564.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 200.0, 560.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 111.0, 44.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "scale-output-max"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 111.0, 44.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "scale-output-min"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 91.0, 56.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 188.0, 25.0, 18.0 ],
					"text" : "clip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 435.0, 412.0, 32.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 41.5, 186.0, 133.5, 186.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 648.5, 66.0, 636.0, 66.0, 636.0, 21.0, 648.5, 21.0 ],
					"source" : [ "obj-5", 0 ]
				}
