{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 72.0, 127.0, 1220.0, 746.0 ],
		"bglocked" : 0,
		"defrect" : [ 72.0, 127.0, 1220.0, 746.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 339.0, 36.0, 21.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 135.0, 157.0, 14.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 659.0, 30.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 23.0, 47.0, 18.0 ],
					"text" : "pre-slide"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 87.0, 22.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 22.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 596.0, 671.0, 573.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 596.0, 635.0, 575.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 508.0, 114.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 342.0, 45.0, 17.0 ],
					"text" : "pak 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 362.0, 88.0, 15.0 ],
					"text" : "setminmax $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 637.0, 512.0, 404.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 136.0, 141.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 42.0, 141.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 165.0, 33.0, 18.0 ],
					"text" : "offset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 165.0, 42.0, 18.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 515.0, 513.0, 65.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 67.0, 64.0, 18.0 ],
					"text" : "window size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 579.0, 513.0, 48.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 66.0, 48.0, 18.0 ],
					"triangle" : 0,
					"varname" : "window"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 58.0, 29.0, 17.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 128.0, 48.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 266.0, 386.0, 161.0, 90.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 157.0, 77.0, 50.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 3
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 83.0, 29.0, 18.0 ],
					"text" : "max"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 83.0, 26.0, 18.0 ],
					"text" : "min"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 114.0, 24.0, 18.0 ],
					"text" : "out"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 93.0, 18.0, 18.0 ],
					"text" : "in"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 139.0, 30.0, 18.0 ],
					"text" : "slide"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 139.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 139.0, 34.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 629.0, 471.0, 397.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 46.0, 113.0, 19.0 ],
					"types" : [  ],
					"varname" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 639.0, 46.0, 562.0, 19.0 ],
					"text" : "jcom.parameter clip @type boolean @range/clipmode none @description \"Turn clipping on.\" @repetitions/allow 1",
					"varname" : "clip[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 94.0, 56.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 114.0, 44.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "scale-output-max"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 114.0, 44.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "scale-output-min"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 94.0, 56.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.0, 188.0, 16.0, 16.0 ],
					"varname" : "clip"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 188.0, 25.0, 18.0 ],
					"text" : "clip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 508.0, 54.0, 58.0, 19.0 ],
					"text" : "jcom.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 448.0, 86.0, 79.0, 19.0 ],
					"text" : "jalg.nav.scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 629.0, 435.0, 412.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 638.0, 555.0, 355.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 634.0, 595.0, 217.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 537.0, 79.0, 457.5, 79.0 ],
					"source" : [ "obj-32", 1 ]
				}
